        ...
        <>
            ...
            <section className="py-5" style={{ background: 'linear-gradient(120deg, var(--ac-grad-start) 0%, var(--ac-grad-end) 100%)' }}>
                <div className="container text-center text-white py-4">
                    ...
                    <p className="lead mb-4">Have questions? Send a message and we’ll get back within 24 hrs.</p>
                </div>
            </section>
                        ...
                        <div className="col-12 col-lg-6">
                            <div className="card border-0 shadow-lg h-100">
                                <div className="card-body p-4">
                                    <h2 className="h5 fw-bold mb-3 text-gradient">Send Us a Message</h2>
                                    <form className="row g-3">
                                        ...
                                        <div className="col-12">
                                            <button type="submit" className="btn btn-gradient w-100 py-2">Send Message</button>
                                        </div>
                                    </form>
                                    <div className="mt-4 d-flex flex-wrap gap-3">
                                        <a href="tel:+919876543210" className="btn btn-outline-primary flex-fill"><i className="bi bi-telephone"></i> Call</a>
                                        <a href="mailto:info@abacusclasses.com" className="btn btn-outline-primary flex-fill"><i className="bi bi-envelope"></i> Email</a>
                                        <a href="https://wa.me/919876543210" className="btn btn-outline-success flex-fill"><i className="bi bi-whatsapp"></i> WhatsApp</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 col-lg-6">
                            <div className="card border-0 shadow-lg h-100">
                                <div className="card-body p-0">
                                    <motion.div className="ratio ratio-16x9 h-100" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                                        <iframe
